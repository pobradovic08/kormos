...
export const mockRouters: MockRouter[] = [
  // HA Pair 1: edge-gw — both online, both 7.16 → "Up to date"
  {
    ...
    serial_number: 'HBE00812A4F2', license_level: 'P1',
    last_config_backup: minutesAgo(45),
  ...
  },
  {
    ...
    routeros_version: '7.16', uptime: '45d 12h',
    serial_number: 'HBE00812A4F3', license_level: 'P1',
    last_config_backup: minutesAgo(45),
    last_seen: minutesAgo(2), created_at: daysAgo(30),
  ...
  // HA Pair 2: core-rtr — both online, 7.16 vs 7.14.3 → "Version mismatch"
  {
    ...
    serial_number: 'AC4300F71B90', license_level: 'P1',
    last_config_backup: hoursAgo(18),
  ...
  },
  {
    ...
    serial_number: 'AC4300F71B91', license_level: 'P1',
    last_config_backup: hoursAgo(18),
    last_seen: minutesAgo(1), created_at: daysAgo(60),
  ...
  // HA Pair 3: branch-rtr — one online (7.14.3), one offline → "Degraded" + "Needs update"
  {
    ...
    serial_number: 'D5E2009C3A44', license_level: 'P-Unlimited',
    last_config_backup: daysAgo(5),
  ...
  },
  {
    ...
    serial_number: 'D5E2009C3A45', license_level: 'P-Unlimited',
    last_config_backup: daysAgo(5),
  ...
  // Standalone: lab-rtr-01 — online, 7.16 → "Up to date"
  {
    ...
    serial_number: 'F19800BE2C10', license_level: 'Free',
    last_config_backup: hoursAgo(1),
  ...
  // Standalone: vpn-gw-01 — online, 7.15.1 → "Needs update"
  {
    ...
    serial_number: '7B3C00A1DE88', license_level: 'P1',
    last_config_backup: hoursAgo(2),
  ...
  // Standalone: backup-rtr-01 — offline
  {
    ...
    serial_number: '2A1E00C4F760', license_level: 'P1',
